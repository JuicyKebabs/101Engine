...
namespace EditorUI
{
	...
	bool FloatField(std::string_view label, float& value, float speed = 0.1f);
	bool UIntField(std::string_view label, unsigned int& value, float speed = 1.0f);
	bool Vector2Field(std::string_view label, Vector2& value, float speed = 0.1f);
	bool Vector3Field(std::string_view label, Vector3& value, float speed = 0.1f);
	bool ColorField(std::string_view label, Vector4& value);
	bool ComboField(
